...
pub(super) fn solve_pattern_exhaustive_constraint(
    subject_ty: Type, patterns: Vec<(Pattern, bool)>, span: Span, type_errors: &mut Vec<TypeErrorInfo>,
...
pub(super) fn solve_pattern_reachable_constraint(
    pattern: Pattern, previous_patterns: Vec<Pattern>, span: Span, type_errors: &mut Vec<TypeErrorInfo>,
) {
